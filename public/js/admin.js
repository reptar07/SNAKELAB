...
const Admin = {
  ...
  colorPresets: ['#000000', '#ffffff', '#e5c07b', '#3ecf91', '#00b8ff', '#ff5f57', '#c56eff', '#ff8a00', '#d9e3f0', '#6b7280'],
  ...
  async saveProduct(e) {
    ...
    const modelFiles = document.getElementById('prod-model').files;
    for (let i = 0; i < modelFiles.length; i++) {
      formData.append('model', modelFiles[i]);
    }
